...
export function AdminPage() {
  ...
  return (
    <AppShell eyebrow="Школа ухода за трахеостомой" title="Панель администратора">
      <section className="admin-summary">
        <div>
          <p>
            Здесь можно добавлять, загружать и публиковать образовательные материалы
            школы ухода за трахеостомой.
          </p>
        </div>
      </section>
